...
/*
* ContentRule function is a simple rule to comment all the cache spark tags.
*/
...
/*
* UseContentRule function is a simple rule to comment all the cache spark tags.
*/
function UseContentRule(element){
ar startTag = "<%- block(':name').toString() %>",
    endTag = "",
